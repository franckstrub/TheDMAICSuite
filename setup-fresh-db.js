...
async function setupFreshDatabase() {
  ...
  try {
    ...
    `);
    console.log('Created project_charters table');
    ...
    `);
    console.log('Created customer_requirements table');
    ...
    `);
    console.log('Created business_requirements table');
    ...
    `);
    console.log('Created sipoc_diagrams table');
    ...
    `);
    console.log('Created data_collection_plans table');
    ...
    `);
    console.log('Created storage_configs table');
    ...
    `);
    console.log('Created project_raci_matrix table');
    ...
    `);
    console.log('Created process_data table');
    ...
    `);
    console.log('Created project_risks table');
    ...
    `);
    console.log('Created gantt_tasks table');
    
    // Create gate_review_deliverables table
    await pool.query(`
      CREATE TABLE IF NOT EXISTS gate_review_deliverables (
        id SERIAL PRIMARY KEY,
        project_id INTEGER NOT NULL,
        phase TEXT NOT NULL,
        deliverable_name TEXT NOT NULL,
        description TEXT,
        is_required TEXT NOT NULL DEFAULT 'Required',
        status TEXT DEFAULT 'Not Started',
        comments TEXT,
        file_path TEXT,
        file_name TEXT,
    ...
    `);
    console.log('Created gate_review_deliverables table');
    
    // Create gate_review_validators table
    await pool.query(`
      CREATE TABLE IF NOT EXISTS gate_review_validators (
        id SERIAL PRIMARY KEY,
        project_id INTEGER NOT NULL,
        phase TEXT NOT NULL,
    ...
    `);
    console.log('Created gate_review_validators table');
