      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-600 text-4xl">
              {" "}
              AI-assisted Quality Improvement & Project Management
            </span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Transform your business processes with intelligent tools powered by
            our premium AI-generated analysis and our unique AI-MBB-assistant.
            <br></br>
            Streamline your DMAIC methodology and drive continuous improvement
            with a single application for Quality Enhancementment, Project
            Management, Statistical Analysis, Documentation, Presentations,
            Approvals, and Gate Review Validation...
          </p>
          <Button
            onClick={handleLogin}
            size="lg"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <CardDescription>
                ...
                management, Deliverables Checklists, Gate Review Validation,
                Approvals, and Benefits tracking.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <CardDescription>
                AI-MBB-Assistant powered by LLM, available all the time for any
                Lean Six Sigma questions and clarifications.
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <CardDescription>
                Advanced timeline & progress tracking with dynamic global and
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent>
              <CardDescription>
                Built-in DMAIC statistical tools per phase ensure DMAIC clarity
                and project success with unique AI-MBB-assistant and premium
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                ...
                with specialized tools and templates. You will get the full
                support of an AI-MBB-assistant and also a lot of AI-generated
                deliverables all along your project.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-white rounded-lg p-6 shadow-md text-center w-64">
                ...
                <p className="text-gray-600 text-sm">
                  Define the problem, establish project charter, define expected
                  benefits, identify customer requirements, create SIPOC
                  diagrams, Risk analysis, RACI, Stakeholder Management, Gantt
                  plan and Elevator speech.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md text-center w-64">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  process capability analysis, and process mapping or value
                  stream mapping.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md text-center w-64">
                ...
                <p className="text-gray-600 text-sm">
                  Identify root causes with Cause & effect diagrams, prioritize
                  them with Cause & Effect matrix, verify your critical root
                  causes with Hypothesis Testing, Regression studies, Multi-vari
                  chart and Pareto analysis.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md text-center w-64">
                ...
                <p className="text-gray-600 text-sm">
                  Develop solutions, assess them with a Benefit-Effort matrix,
                  define an implementation plan, conduct pilot tests, and
                  implement process improvements. Statistically demonstrate your
                  improvements.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md text-center w-64">
                ...
                <p className="text-gray-600 text-sm">
                  Establish control plans, implement statistical process
                  control, and monitor ongoing performance. Transfer your
                  project to the process owner and close it.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <p className="text-gray-600 italic mb-4">
                  ...
                  how quickly we can identify issues and implement solutions.
                  Our team's productivity has increased by 30%."
                </p>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <p className="text-gray-600 italic mb-4">
                  ...
                  effortlessly. We've seen a 25% reduction in project completion
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white rounded-lg p-8 shadow-md border border-gray-200">
                ...
                <p className="text-gray-600 mb-6">
                  For individuals and solopreneurs just getting started with
                  Lean Six Sigma
                </p>
              ...
              <div className="bg-white rounded-lg p-8 shadow-xl border-2 border-primary relative">
                ...
                <p className="text-gray-600 mb-6">
                  For professional improvement teams with advanced needs in Lean
                  Six Sigma
                </p>
                <div className="text-4xl font-bold mb-6">
                  $99
              ...
              <div className="bg-white rounded-lg p-8 shadow-md border border-gray-200">
                ...
                <p className="text-gray-600 mb-6">
                  For organizations with comprehensive requirements in Lean Six
                  Sigma
                </p>
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check text-green-500 mr-2"></i>
                    <span>
                      All database storage options (cloud/server/local)
                    </span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-green-500 mr-2"></i>
                    <span>
                      Single tenant Enterprise databasewith high security
                    </span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-green-500 mr-2"></i>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Follow proven Lean Six Sigma methodologies with guided
                workflows, templates and tools all in one application.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Track progress, timeline and benefits, identify performamce
                issues, analyze their root causes and measure improvements in
                real-time.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Unique AI-MBB-Assistant which act like a Master Black Belt
                coach. Ask it any questions you have about Lean Six Sigma and
                get relevant and comprehensive answers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join the many professionals who trust our platform for their
            Operational Excellence and Lean Six Sigma projects.
          </p>
          <Button
            onClick={handleLogin}
            size="lg"
        ...
        <footer className="text-center text-sm text-gray-600 py-4 border-t border-gray-200 mt-auto">
          <p className="mb-2">
            ...
            &nbsp;&nbsp;|&nbsp;&nbsp;The Lean Six Sigma DMAIC Suite™ is edited
            by{" "}
            <a
              href="https://equable.fr"
              target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/franckstrubequable/"
            target="_blank"
            rel="noopener noreferrer"
