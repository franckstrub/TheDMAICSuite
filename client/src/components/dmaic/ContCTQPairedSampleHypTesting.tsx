  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        <p className="text-sm text-gray-500 mb-4">
          Validate or invalidate assumptions and determine if differences are statistically significant or insignificant in two paired samples.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="max-w-4xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  id={`${ctqId}-MeanTest`}
                  checked={ContCTQPairedSampleHypTestData[ctqId]?.enableMeanTest || false}
                  onCheckedChange={(checked) => updateContCTQPairedSampleHypTestDataField(ctqId, "enableMeanTest", checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  checked={ContCTQPairedSampleHypTestData[ctqId]?.enableVarianceTest || false}
                  onCheckedChange={(checked) => updateContCTQPairedSampleHypTestDataField(ctqId, "enableVarianceTest", checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id={`${ctqId}-MedianTest`}
                  checked={ContCTQPairedSampleHypTestData[ctqId]?.enableMedianTest || false}
                  onCheckedChange={(checked) => updateContCTQPairedSampleHypTestDataField(ctqId, "enableMedianTest", checked)}
                />
          ...
          <div className="flex flex-wrap gap-4 items-end"> {/* Changed from space-y-3 to flexbox */}
            ...
            {ContCTQPairedSampleHypTestData[ctqId]?.enableVarianceTest && (
            ...
            {ContCTQPairedSampleHypTestData[ctqId]?.enableMedianTest && (
                <div className="flex-1 min-w-[100px]"> {/* Added flex-1 and min-width */}
                    <Label>Target value for median:</Label>
                    <Input
                        type="number"
                        value={ContCTQPairedSampleHypTestData[ctqId]?.targetMedian || 0}
                        onChange={(e) => updateContCTQPairedSampleHypTestDataField(
                            ctqId, 
                            "targetMedian", 
                            parseFloat(e.target.value) || 0
          ...
          <div>
            ...
            <Input
                type="text"
                value={ContCTQPairedSampleHypTestData[ctqId]?.datasetdescription || ""}
                onChange={(e) => updateContCTQPairedSampleHypTestDataField(
                    ctqId, 
                    "datasetdescription", 
                    e.target.value
