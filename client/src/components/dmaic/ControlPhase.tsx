      ...
      <div className="mb-4 flex flex-row gap-4">
        ...
        <Card className="w-1/2 bg-blue-50">
          <CardHeader className="pb-2">
            <CardTitle className="text-md">Control Phase Progress</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="border rounded-md p-3 bg-white">
                  <div className="text-xs text-gray-500 mb-1">Control Plan</div>
                ...
                <div className="border rounded-md p-3 bg-white">
                  <div className="text-xs text-gray-500 mb-1">Process Documentation</div>
                  <div className="flex items-center">
                ...
                <div className="border rounded-md p-3 bg-white">
                  <div className="text-xs text-gray-500 mb-1">Training Plan</div>
                  <div className="flex items-center">
                    <div className="h-2.5 w-2.5 rounded-full bg-gray-300 mr-2"></div>
                    <span className="text-sm font-medium">Not Started</span>
                  </div>
                ...
                <div className="border rounded-md p-3 bg-white">
                  <div className="text-xs text-gray-500 mb-1">Monitoring System</div>
                  <div className="flex items-center">
                    <div className="h-2.5 w-2.5 rounded-full bg-gray-300 mr-2"></div>
                    <span className="text-sm font-medium">Not Started</span>
                  </div>
              ...
              <div className="text-sm font-medium mt-2">
                ...
                <ul className="text-sm font-normal mt-1 pl-5 list-disc">
                  <li>Complete control plan documentation</li>
                  <li>Establish measurement system for ongoing monitoring</li>
                  <li>Develop training materials for process owners</li>
                </ul>
              </div>
            </div>
          </CardContent>
