  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      try {
        ...
        // Show error message only if no PDF was generated yet
        if (!pdfGenerated) {
          toast({
            title: "Export Failed",
            description: "Unable to generate PDF. Try collapsing some sections before exporting.",
            variant: "destructive",
          });
        } else {
          // If a PDF was already generated, just log the error
