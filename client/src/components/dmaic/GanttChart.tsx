                ...
                (() => {
                  ...
                  return (
                    <div className="flex flex-col">
                      ...
                      {/* Week headers - Second row */}
                      <div className="flex sticky top-6 z-20">
              ...
              >
                ...
                <div className="gantt-timeline w-3/4 relative flex bg-transparent">
                  {timelineView === 'weeks' ? (
                    ...
                    // Month view - with alternating background colors for weeks like row #2
                    (() => {
                        ...
                        {/* <div className="w-full h-full relative flex"> */}
                          {uniqueWeeks.map((week, weekIndex) => (
                            <div 
                              ...
                              className={cn(
                                "h-full border-r border-gray-300 flex flex-col flex-shrink-0",
