...
export function twosampleVarianceHypothesisTest({
  ...
  if (ADp_Value1 >= significance && ADp_Value2 >= significance) {
    ...
    varStatistic = calculate2SvarFisherValue(
      sample1Variance,
      sample2Variance,
      ratioVariance0,
    );
    ...
    varCriteria = calculate2SvarFisherCriticalValue(
      significance,
      df1,
      df2,
      alternativevariance,
    ...
    // Calculate p-value
    varp_Value = calculate2SvarFisherPValue(
      varStatistic,
      df1,
      df2,
      alternativevariance,
    ...
    varCriteria = calculate2SvarLeveneCriticalValue(
      significance,
      df1,
      df2,
      alternativevariance,
    ...
    // Calculate p-value
    varp_Value = calculate2SvarLevenePValue(
      varStatistic,
      df1,
      df2,
      alternativevariance,
  ...
  return {
    ...
    varStatistic,
    varCriteria:
      typeof varCriteria === "number"
        ? varCriteria
        : { lower: varCriteria.lower, upper: varCriteria.upper },
    varp_Value,
    varianceCI_minus,
    varianceCI_plus,
  };
