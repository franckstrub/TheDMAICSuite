...
- July 9, 2025. Fixed ContCTQHypTesting undo clearing all data by implementing truly granular undo - changed paste operations to save individual data point additions instead of bulk operations, each pasted value now creates separate undo states, cell paste operations save individual cell changes, ensuring Ctrl+Z undoes one data point at a time instead of entire paste operations
