...
- July 22, 2025. Added comprehensive power analysis fields to one_sample_hypothesis_config database table - added 19 new fields supporting Mean, Variance, and Median power analysis calculations including enablers (enableMean1SPower, enableVariance1SPower, enableMedian1SPower), power parameters (power, Ha, mean/stdev/median values, H0, alpha) for all three test types, enabling advanced statistical power analysis functionality in one-sample hypothesis testing
