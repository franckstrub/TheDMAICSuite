  ...
  app.post("/api/projects/:projectId/process-capability", isAuthenticated, async (req, res) => {
    try {
      ...
      const processedData = {
        ...
        totalUnits: totalUnits !== undefined ? totalUnits : null,
        dpmoDefects: dpmoDefects !== undefined ? dpmoDefects : null,
        dpmoUnits: dpmoUnits !== undefined ? dpmoUnits : null,
        dpmoOpportunitiesPerUnit: dpmoOpportunitiesPerUnit !== undefined ? dpmoOpportunitiesPerUnit : null,
        rtyProcessSteps: rtyProcessSteps || null,
        oeeScheduledTime: oeeScheduledTime !== undefined ? oeeScheduledTime : null,
        oeeAvailableTime: oeeAvailableTime !== undefined ? oeeAvailableTime : null,
        oeeNominalCapacity: oeeNominalCapacity !== undefined ? oeeNominalCapacity : null,
        oeePartsManufactured: oeePartsManufactured !== undefined ? oeePartsManufactured : null,
        oeeBadParts: oeeBadParts !== undefined ? oeeBadParts : null,
        paretoDefectCategories: paretoDefectCategories || null,
        dpuDefects: dpuDefects !== undefined ? dpuDefects : null,
        dpuUnits: dpuUnits !== undefined ? dpuUnits : null,
        projectId,
        organizationId: userRecord.organizationId,
      };
