...
import { 
  ...
  insertContinuousCtqAnalysisConfigSchema, insertAttributeCtqAnalysisConfigSchema, insertAttributeHypothesisTestingConfigSchema, insertOneSampleHypothesisConfigSchema,
...
import { 
  ...
  continuousCtqAnalysisConfig, attributeCtqAnalysisConfig, attributeHypothesisTestingConfig, twoProportionHypothesisConfig, insertTwoProportionHypothesisConfigSchema, oneSampleHypothesisConfig, twoSampleHypothesisConfig, pairedSampleHypothesisConfig, multipleSampleHypothesisConfig, hypothesisTestingConfig,
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/auth/user', isAuthenticated, async (req: any, res) => {
    try {
      ...
      console.log("Auth user response - User data:", JSON.stringify(user, null, 2));
      res.json(user);
    } catch (error) {
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/attribute-hypothesis-testing-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(attributeHypothesisTestingConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/two-proportion-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(twoProportionHypothesisConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/two-proportion-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/one-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(oneSampleHypothesisConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/one-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      // Validate the configuration data
      const validatedData = insertOneSampleHypothesisConfigSchema.parse(configData);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/two-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(twoSampleHypothesisConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/two-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      // Validate the configuration data
      const validatedData = insertTwoSampleHypothesisConfigSchema.parse(configData);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/paired-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(pairedSampleHypothesisConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/paired-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      // Validate the configuration data
      const validatedData = insertPairedSampleHypothesisConfigSchema.parse(configData);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/multiple-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(multipleSampleHypothesisConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/multiple-sample-hypothesis-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      // Validate the configuration data
      const validatedData = insertMultipleSampleHypothesisConfigSchema.parse(configData);
  ...
  app.get("/api/projects/:projectId/ctq/:ctqId/hypothesis-testing-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      const [config] = await db
        ...
        .where(and(
          ...
          eq(hypothesisTestingConfig.organizationId, userRecord.organizationId)
        ))
        .limit(1);
  ...
  app.post("/api/projects/:projectId/ctq/:ctqId/hypothesis-testing-config", isAuthenticated, async (req: Request, res: Response) => {
    try {
      const projectId = parseInt(req.params.projectId);
      const ctqId = parseInt(req.params.ctqId);
      ...
      // Validate the configuration data
      const validatedData = insertHypothesisTestingConfigSchema.parse(configData);
